  ...
  return (
    <section id="projects" className="mx-auto mt-24 max-w-6xl px-6">
      <div className="space-y-4">
        ...
        <h2 className="section-title">Production experience & live repositories</h2>
        <p className="section-subtitle">
          Live GitHub work pulls straight into this portfolio. Flagship case studies highlight how Kingsley scales delivery with modern TypeScript, cloud, and automation.
        </p>
      </div>
